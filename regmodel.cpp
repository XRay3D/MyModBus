...
Model::Model(QObject* parent)
    ...
    , m_data{
        ...
        Data{ Data::REG_18, uint16_t{}, Data::ReadWrite },
    ...
    } //
{
    ...
    m_type = typeName(std::make_index_sequence<std::variant_size_v<Reg::Data::variant>>{});
}

int Model::rowCount(const QModelIndex&) const { return m_data.size(); }

int Model::columnCount(const QModelIndex&) const { return ColumnCount; }
